...
@EnableZuulProxy
public class HalalStoreGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(HalalStoreGatewayApp.class);

    private final Environment env;

    public HalalStoreGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes HalalStoreGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HalalStoreGatewayApp.class);
